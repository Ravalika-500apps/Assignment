<template>
    <button
      ...
      <div>
        <div class="mt-[2rem] sm:ml-[118rem] sm:flex-none">
    ...
    const emit = defineEmits (['add-page'])
    ...
    //passing the data from emit for adding the pages
    const addPage = ()=>{
     const formData = {
         name: name.value,
